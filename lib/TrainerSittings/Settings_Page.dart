...
Widget Waitforme() {
  ...
  Future<void> logOut() async {
    var body1 = jsonEncode({'logout': 'trainer'});

    var res = await http.post(Uri.parse(global.globall + "/trainer/log-out"),
        headers: {
  ...
  Future<void> deleteAcoount() async {
    ...
    var res = await http.post(Uri.parse(global.globall + "/trainer/deleteMe"),
        headers: {
          'Content-Type': 'application/json; charset=UTF-8',
          'token': global.token
        },
