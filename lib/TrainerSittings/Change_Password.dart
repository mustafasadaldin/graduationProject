...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  void _displayErrorMotionToastPassword() {
    MotionToast.error(
      ...
      description: Text(
          'password must be at least 8 characters of 2 digits, 1 symbol,uppercase,lowercase'),
      animationType: AnimationType.fromLeft,
      position: MotionToastPosition.top,
      width: 300,
      height: 120,
  ...
  Future<void> modifyPassword() async {
    var body1 = jsonEncode({'password': NewPass.text});

    var res =
        await http.post(Uri.parse(global.globall + "/trainers/update-password"),
            headers: {
